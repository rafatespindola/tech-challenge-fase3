 ...
 * 401 quando nao ha token valido, 403 quando ha mas a role nao basta. O formato
 * e o mesmo ProblemDetail que o ApiExceptionHandler ja devolve, para o cliente
 * nao ter que lidar com dois formatos de erro.
 */
@Component
