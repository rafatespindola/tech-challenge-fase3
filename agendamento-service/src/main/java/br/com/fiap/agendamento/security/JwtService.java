...
public class JwtService {
    ...
    /**
     * Piso de 256 bits: abaixo disso a jjwt recusa assinar. Acima, ela escolhe o
     * HMAC-SHA mais forte que a chave sustenta (48 bytes viram HS384, 64 viram
     * HS512), entao o algoritmo efetivo depende do tamanho do segredo.
     */
    ...
    public Token gerar(UsuarioAutenticado usuario) {
        ...
        // As claims de vinculo entram nulas quando nao se aplicam; a jjwt
        // simplesmente nao as escreve, e a leitura devolve null.
        String valor = Jwts.builder()
                ...
                .claim(CLAIM_PACIENTE_ID, usuario.pacienteId())
                .claim(CLAIM_PROFISSIONAL_ID, usuario.profissionalId())
